...
final class DropboxSessionManager: ObservableObject {
    ...
    private static let defaultFolderDefaultsKey = "mobileRecorder.dropbox.defaultFolderPath"

    private init() {
        self.defaultFolderPath = UserDefaults.standard.string(forKey: Self.defaultFolderDefaultsKey) ?? "/auto.transcribe.agent"
